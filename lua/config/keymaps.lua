...
map('n', '<Leader><leader>d', 'm`""Y""P``', { desc = 'Duplicate line' })
map('x', '<Leader><leader>d', '""Y""Pgv', { desc = 'Duplicate selection' })
...
-- New file
map('n', '<leader><leader>n', '<cmd>enew<cr>', { desc = 'New File' })

-- Fast saving from all modes
map('n', '<Leader><leader>w', '<cmd>write<CR>', { desc = 'Save File' })
...
map('n', '<leader><leader>b', '<cmd>buffer#<CR>', { desc = 'Alternate buffer' })
map('n', '<leader><leader>c', '<cmd>close<CR>', { desc = 'Close window' })
map('n', '<leader><leader>d', '<cmd>bdelete<CR>', { desc = 'Buffer delete' })
map('n', '<leader><leader>h', '<cmd>split<CR>', { desc = 'Split window horizontally' })
map('n', '<leader><leader>v', '<cmd>vsplit<CR>', { desc = 'Split window vertically' })
map('n', '<leader><leader>t', '<cmd>tabnew<CR>', { desc = 'New tab' })
map('n', '<leader><leader>o', '<cmd>only<CR>', { desc = 'Close other windows' })
map('n', '<leader><leader>q', '<cmd>qa<CR>', { desc = 'Exit Neovim' })
