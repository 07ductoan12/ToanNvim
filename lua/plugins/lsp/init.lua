...
M = {
	...
	{ import = 'plugins.extras.lsp.lightbulb' },
...
if ConfigVariable.lang.python then
	table.insert(M, { import = 'plugins.extras.lang.python' })
end

if ConfigVariable.lang.golang then
	table.insert(M, { import = 'plugins.extras.lang.go' })
end

if ConfigVariable.lang.markdown then
	table.insert(M, { import = 'plugins.extras.lang.markdown' })
end

if ConfigVariable.lang.java then
	table.insert(M, { import = 'plugins.extras.lang.java' })
end

if ConfigVariable.lang.cpp then
	table.insert(M, { import = 'plugins.extras.lang.cpp' })
end

if ConfigVariable.lang.typescript then
	table.insert(M, { import = 'plugins.extras.lang.typescript' })
end

if ConfigVariable.lang.scala then
	table.insert(M, { import = 'plugins.extras.lang.scala' })
end
